...
import type { DocumentLike, ElementLike, TextElementLike } from "./types.js";
...
export function clear(el: TextElementLike): void {
  el.textContent = "";
}

export function asEl(node: TextElementLike | null): ElementLike | null {
  return node as ElementLike | null;
}

export function div(doc: DocumentLike, className: string, text?: string): ElementLike {
...
export function span(doc: DocumentLike, className: string, text: string): ElementLike {
...
export function glyph(doc: DocumentLike, paths: readonly string[], className: string, strokeWidth = 2): ElementLike {
