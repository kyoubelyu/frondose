...
const en = {
    ...
    "identity.hint": "Open Frondose → Settings to set your identity.",
    ...
    "settings.groupSearch": "Search",
    "settings.braveKey": "Brave Search API key",
...
const zhCN = {
    ...
    "identity.hint": "请打开 Frondose → 设置，填写你的身份信息。",
