...
// P-AUTO-17 intentionally appended `unresolvable_ref_on_outbound_surface` to the guard-reason
// slash-list at soul.ts:169. The locked literal is re-anchored to the new verbatim production text
// per the D-A14.1 supersession precedent (intentional change → update the lock, byte-identity preserved).
