...
describe("STEALTH_INIT_SCRIPT navigator.webdriver toString fix — G-P32.19", () => {
  it(
    "T-ST.1: after P-32 stealth edit, navigator.webdriver getter returns undefined",
    () => {
  ...
  it(
    "T-ST.2: navigator.webdriver getter's own toString returns 'function get webdriver() { [native code] }' (1-level fix, OQ-5)",
    () => {
