...
describe("P-41 contract — makeAllTools server mode count (G-P41.7)", () => {
  it("T-C.1: makeAllTools({ mode:'server', ... }) returns 27 tools including 'provision_worker' and 'present_summary'", () => {
    ...
    //
    // Server mode tool list (27 total; P-Y3 rebaseline from P-41-era 23):
    ...
    //   + suggest_card/suggest_next_actions [P-57a] + todo_write [P-Y1] + present_summary [P-Y3] = 27
